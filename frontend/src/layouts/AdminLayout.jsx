      ...
      <aside className="w-64 bg-slate-950 border-r border-slate-800 flex flex-col justify-between p-6">
        <div>
          ...
          <nav className="space-y-2">
            ...
            <Link to="/admin/academic" className="flex items-center space-x-3 px-4 py-2.5 rounded-lg text-slate-400 hover:bg-slate-900 hover:text-slate-200 transition-all">
                <span>📚</span> <span>Academic Modules</span>
            </Link>
            <Link to="/admin/assignments" className="flex items-center space-x-3 px-4 py-2.5 rounded-lg text-slate-400 hover:bg-slate-900 hover:text-slate-200 transition-all">
